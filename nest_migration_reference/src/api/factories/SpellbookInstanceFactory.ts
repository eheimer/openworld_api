...
export default class SpellbookInstanceFactory extends EntityFactory<SpellbookInstance> {
  constructor() {
  ...
  async makeDummyWithAll(faker?: Faker.FakerStatic): Promise<SpellbookInstance> {
    if (!faker) faker = defaultFaker
