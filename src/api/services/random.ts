export abstract class RandomService {
   ...
   */
  static getRandomInRange(arg1: number | number[] | string, arg2?: number): number {
   ...
   */
  static getRandomItems(arr: any[], count: number, weights: number[], dispose = true): any[] {
    const items: any[] = []
    count = count ? count : 1
   ...
   * @param {*} dispose specify false to prevent the chosen item from being removed from the provided array
   */
  static getOneRandomItem(arr: any[], weights?: number[], dispose?: boolean): any {
